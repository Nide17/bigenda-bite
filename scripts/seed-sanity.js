  ...
  const processes = [
    {
      ...
      officialSource: 'Rwanda Development Board',
      category: 'business',
      status: 'published',
      ...
      summary: 'Step-by-step guide to register a business in Rwanda through RDB.',
      eligibility: ['Rwandan citizens', 'Foreign investors', 'Residents with valid permits'],
      requirements: ['Valid ID', 'TIN certificate', 'Proof of address'],
      steps: [
      ...
      requiredDocuments: ['ID', 'TIN', 'Passport photos'],
      whereToApply: { description: 'RDB Head Office, Kigali or online via Irembo', mapsLink: 'https://maps.google.com/?q=RDB+Kigali' },
      onlineApplicationUrl: 'https://irembo.gov.rw/',
      contactInfo: { phone: '+250 788 000 000', email: 'info@rdb.rw', website: 'https://rdb.rw/' },
    ...
    },
    {
      ...
      summary: 'How to apply for a Rwandan National ID through Irembo.',
      eligibility: ['Rwandan citizens', 'Age 16 and above'],
      requirements: ['Birth certificate', 'Proof of residence', 'Passport photos'],
      steps: [
      ...
      requiredDocuments: ['Birth certificate', 'Proof of residence'],
      whereToApply: { description: 'Online via Irembo or at local sector office' },
      onlineApplicationUrl: 'https://irembo.gov.rw/',
      contactInfo: { phone: '+250 788 000 000', website: 'https://irembo.gov.rw/' },
      officialPortal: 'https://irembo.gov.rw/',
    ...
    },
    {
      _type: 'process',
      sourceType: 'official_verified',
      officialSource: 'Directorate General of Immigration and Emigration',
      ...
      summary: 'Steps to apply for a Rwandan visa online or on arrival.',
      eligibility: ['Foreign nationals', 'Valid passport required'],
      requirements: ['Valid passport', 'Passport photo', 'Yellow fever vaccination certificate'],
      steps: [
      ...
      requiredDocuments: ['Passport', 'Photo', 'Yellow fever certificate'],
      whereToApply: { description: 'Online or at port of entry' },
      onlineApplicationUrl: 'https://www.migration.gov.rw/',
      contactInfo: { phone: '+250 788 000 000', website: 'https://www.migration.gov.rw/' },
    ...
    },
    {
      _type: 'process',
      sourceType: 'official_verified',
      officialSource: 'Ministry of Health',
      category: 'health',
      status: 'published',
      ...
      summary: "How to enroll in Rwanda's community health insurance.",
      eligibility: ['All Rwandan residents'],
      ...
      whereToApply: { description: 'Local health center (Centre de Sante)' },
      onlineApplicationUrl: '',
      contactInfo: { phone: '+250 788 000 000', website: 'https://www.mutuelle.gov.rw/' },
    ...
    },
    {
      _type: 'process',
      sourceType: 'official_verified',
      officialSource: 'Rwanda Revenue Authority',
      category: 'business',
      status: 'published',
      tags: ['tax', 'RRA'],
      translations: {
      ...
      summary: 'Steps to register for a TIN and tax obligations in Rwanda.',
      eligibility: ['Business owners', 'Self-employed individuals'],
      requirements: ['ID', 'Business registration certificate'],
      steps: [
      ...
      fees: [{ label: 'Registration fee', amountRWF: 0, conditions: 'free' }],
      requiredDocuments: ['ID', 'Business registration certificate'],
      whereToApply: { description: 'RRA office or online via RRA portal' },
      onlineApplicationUrl: 'https://www.rra.gov.rw/',
      contactInfo: { phone: '+250 788 000 000', website: 'https://www.rra.gov.rw/' },
  ...
  const guides = [
    {
      ...
      summary: 'Tips for booking your first flight to Kigali.',
      steps: [
    ...
    },
    {
      ...
      summary: 'Step-by-step guide to purchasing land safely.',
      steps: [
    ...
    },
    {
      ...
      summary: "How to use Kigali's bus system and tap cards.",
      steps: [
    ...
    },
    {
      ...
      summary: 'What to know before renting in Kigali or other cities.',
      steps: [
    ...
    },
    {
      ...
      summary: 'How to find public and private health facilities near you.',
      steps: [
    ...
    },
    {
      ...
      summary: 'How to register a child in a Rwandan primary or secondary school.',
      steps: [
    ...
    },
    {
      ...
      summary: 'How to get a Rwandan SIM card and affordable data plan.',
      steps: [
    ...
    },
    {
      ...
      summary: 'What you need and which banks to consider.',
      steps: [
    ...
    },
    {
      ...
      summary: 'Useful everyday phrases to help you settle in Rwanda.',
      steps: [
    ...
    },
    {
      ...
      summary: 'Key emergency contacts and basic safety advice.',
      steps: [
  ...
  const alerts = [
    {
      ...
      translations: {
        en: { title: 'RDB business registration fee updated', summary: 'RDB business registration fee updated from free to 5,000 RWF.' },
        fr: { title: 'Frais d\'enregistrement RDB mis a jour', summary: 'Frais d\'enregistrement RDB mis a jour de gratuit a 5 000 RWF.' },
        rw: { title: 'Igiciro cy\'kwiyandikisha ubucuruzi kuri RDB cyahinduwe', summary: 'Igiciro cy\'kwiyandikisha ubucuruzi kuri RDB cyahinduwe kuva 0 kugera 5,000 RWF.' },
      },
    },
    {
      _type: 'alert',
      ...
      translations: {
        en: { title: 'RDB Kigali branch closure', summary: 'RDB Kigali branch will be closed for maintenance on August 20, 2026.' },
        fr: { title: 'Fermeture de l\'agence RDB de Kigali', summary: 'L\'agence RDB de Kigali sera fermee pour maintenance le 20 aout 2026.' },
        rw: { title: 'Ibiro bya RDB bya Kigali bizahagarikwa', summary: 'Ibiro bya RDB bya Kigali bizahagarikwa ku buryo bwo gusukura ku itariki ya 20 Kanama 2026.' },
      },
    },
  ]
