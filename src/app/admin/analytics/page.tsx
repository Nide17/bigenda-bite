...
export default async function AdminAnalyticsPage() {
  ...
  const metrics = [
    { label: 'Page Views', value: summary.pageViews.toLocaleString(), sub: `Last ${summary.days} days` },
    { label: 'Ad Clicks', value: summary.adClicks.toLocaleString(), sub: `Last ${summary.days} days` },
    { label: 'Payments', value: summary.payments.toLocaleString(), sub: `Last ${summary.days} days` },
    { label: 'Contributions', value: summary.contributions.toLocaleString(), sub: `Last ${summary.days} days` },
    { label: 'Leads', value: summary.leads.toLocaleString(), sub: `Last ${summary.days} days` },
  ]
  ...
  return (
    <PageContainer>
      <div className="mb-8">
        ...
        <p className="text-sm text-neutral-500 mt-1">Performance, traffic, and revenue overview.</p>
      </div>
